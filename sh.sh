cd /Applications
ls -al
rm -rf Julia-1.6.app PowerShell.app R.app VirtualBox.app "Visual Studio.app" Xcode_10.3.app Xcode_11.2.1.app Xcode_11.3.1.app Xcode_11.4.1.app Xcode_11.5.app Xcode_11.6.app Xcode_11.7.app
